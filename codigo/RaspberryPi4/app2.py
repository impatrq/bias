...
from run_task2 import MotorTask, ProcessingTask, FilterTask, EEGProcessor
...
def run_capture_and_combine_eeg():
    print("Capturing and combining EEG data...")
    
    motor_task = MotorTask()
    processing_task = ProcessingTask()
    filter_task = FilterTask()
    
    eeg_processor = EEGProcessor()
    eeg_processor.run_all_tasks()
    
    print("EEG data captured and combined successfully.")
